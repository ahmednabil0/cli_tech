...
class PersonalInfoPatientPage extends StatelessWidget {
  const PersonalInfoPatientPage({super.key});
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  10.he(),
                  MyCustomTextField(
                    controller: TextEditingController(text: 'Noha Ali'),
                    lapel: 'Name',
                    width: 290.w,
                  ),
                  10.he(),
                  MyCustomTextField(
                    controller:
                        TextEditingController(text: 'noha.ali@gmail.com'),
                    lapel: 'Email',
                    width: 290.w,
                  ),
                  10.he(),
                  MyCustomTextField(
                    controller: TextEditingController(text: '01061028467'),
                    lapel: 'Phone Number',
                    width: 290.w,
                  ),
                  10.he(),
