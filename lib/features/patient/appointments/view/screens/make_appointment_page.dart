    ...
    return Scaffold(
      ...
      body: BlocBuilder<AppointmentCubit, AppointmentState>(
        builder: (context, state) {
          return Background(
              child: state == const AppointmentState.loadingState()
                  ? const Center(
                      child: SpinKitCircle(color: AppColors.scColor),
                    )
                  : Column(
                      children: [
                        Expanded(
                                ...
                                BlocProvider.of<AppointmentCubit>(context)
                                    ...
                                    ? Container(
                                        ...
                                        child: appText(
                                          ...
                                          ml: 3,
                                          txt:
                                              'Choose Valid Date To Get Available Hours',
